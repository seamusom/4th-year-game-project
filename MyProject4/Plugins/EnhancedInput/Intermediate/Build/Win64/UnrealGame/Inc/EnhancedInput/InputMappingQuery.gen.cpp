...
template<> ENHANCEDINPUT_API UScriptStruct* StaticStruct<FMappingQueryIssue>()
{
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FMappingQueryIssue_Statics::NewProp_Issue_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FMappingQueryIssue_Statics::NewProp_Issue = { "Issue", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMappingQueryIssue, Issue), Z_Construct_UEnum_EnhancedInput_EMappingQueryIssue, METADATA_PARAMS(Z_Construct_UScriptStruct_FMappingQueryIssue_Statics::NewProp_Issue_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMappingQueryIssue_Statics::NewProp_Issue_MetaData)) }; // 1804607089
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FMappingQueryIssue_Statics::NewProp_BlockingAction = { "BlockingAction", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMappingQueryIssue, BlockingAction), Z_Construct_UClass_UInputAction_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FMappingQueryIssue_Statics::NewProp_BlockingAction_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMappingQueryIssue_Statics::NewProp_BlockingAction_MetaData)) };
	...
	struct Z_CompiledInDeferFile_FID_MyProject4_Plugins_EnhancedInput_Source_EnhancedInput_Public_InputMappingQuery_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MyProject4_Plugins_EnhancedInput_Source_EnhancedInput_Public_InputMappingQuery_h_Statics::EnumInfo[] = {
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MyProject4_Plugins_EnhancedInput_Source_EnhancedInput_Public_InputMappingQuery_h_Statics::ScriptStructInfo[] = {
		{ FMappingQueryIssue::StaticStruct, Z_Construct_UScriptStruct_FMappingQueryIssue_Statics::NewStructOps, TEXT("MappingQueryIssue"), &Z_Registration_Info_UScriptStruct_MappingQueryIssue, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMappingQueryIssue), 2873119118U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MyProject4_Plugins_EnhancedInput_Source_EnhancedInput_Public_InputMappingQuery_h_4243223040(TEXT("/Script/EnhancedInput"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_MyProject4_Plugins_EnhancedInput_Source_EnhancedInput_Public_InputMappingQuery_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MyProject4_Plugins_EnhancedInput_Source_EnhancedInput_Public_InputMappingQuery_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_MyProject4_Plugins_EnhancedInput_Source_EnhancedInput_Public_InputMappingQuery_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MyProject4_Plugins_EnhancedInput_Source_EnhancedInput_Public_InputMappingQuery_h_Statics::EnumInfo));
