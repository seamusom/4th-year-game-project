...
template<> ENHANCEDINPUT_API UScriptStruct* StaticStruct<FBlueprintInputDebugKeyDelegateBinding>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FBlueprintInputDebugKeyDelegateBinding_Statics::NewProp_InputChord = { "InputChord", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBlueprintInputDebugKeyDelegateBinding, InputChord), Z_Construct_UScriptStruct_FInputChord, METADATA_PARAMS(Z_Construct_UScriptStruct_FBlueprintInputDebugKeyDelegateBinding_Statics::NewProp_InputChord_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBlueprintInputDebugKeyDelegateBinding_Statics::NewProp_InputChord_MetaData)) }; // 3880295606
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FBlueprintInputDebugKeyDelegateBinding_Statics::NewProp_InputKeyEvent = { "InputKeyEvent", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBlueprintInputDebugKeyDelegateBinding, InputKeyEvent), Z_Construct_UEnum_Engine_EInputEvent, METADATA_PARAMS(Z_Construct_UScriptStruct_FBlueprintInputDebugKeyDelegateBinding_Statics::NewProp_InputKeyEvent_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBlueprintInputDebugKeyDelegateBinding_Statics::NewProp_InputKeyEvent_MetaData)) }; // 1054153585
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FBlueprintInputDebugKeyDelegateBinding_Statics::NewProp_bExecuteWhenPaused = { "bExecuteWhenPaused", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FBlueprintInputDebugKeyDelegateBinding), &Z_Construct_UScriptStruct_FBlueprintInputDebugKeyDelegateBinding_Statics::NewProp_bExecuteWhenPaused_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FBlueprintInputDebugKeyDelegateBinding_Statics::NewProp_bExecuteWhenPaused_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBlueprintInputDebugKeyDelegateBinding_Statics::NewProp_bExecuteWhenPaused_MetaData)) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UInputDebugKeyDelegateBinding_Statics::NewProp_InputDebugKeyDelegateBindings_Inner = { "InputDebugKeyDelegateBindings", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FBlueprintInputDebugKeyDelegateBinding, METADATA_PARAMS(nullptr, 0) }; // 750038629
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UInputDebugKeyDelegateBinding_Statics::NewProp_InputDebugKeyDelegateBindings = { "InputDebugKeyDelegateBindings", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UInputDebugKeyDelegateBinding, InputDebugKeyDelegateBindings), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UInputDebugKeyDelegateBinding_Statics::NewProp_InputDebugKeyDelegateBindings_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UInputDebugKeyDelegateBinding_Statics::NewProp_InputDebugKeyDelegateBindings_MetaData)) }; // 750038629
	...
	struct Z_CompiledInDeferFile_FID_MyProject4_Plugins_EnhancedInput_Source_EnhancedInput_Public_InputDebugKeyDelegateBinding_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MyProject4_Plugins_EnhancedInput_Source_EnhancedInput_Public_InputDebugKeyDelegateBinding_h_Statics::ScriptStructInfo[] = {
		{ FBlueprintInputDebugKeyDelegateBinding::StaticStruct, Z_Construct_UScriptStruct_FBlueprintInputDebugKeyDelegateBinding_Statics::NewStructOps, TEXT("BlueprintInputDebugKeyDelegateBinding"), &Z_Registration_Info_UScriptStruct_BlueprintInputDebugKeyDelegateBinding, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FBlueprintInputDebugKeyDelegateBinding), 750038629U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MyProject4_Plugins_EnhancedInput_Source_EnhancedInput_Public_InputDebugKeyDelegateBinding_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UInputDebugKeyDelegateBinding, UInputDebugKeyDelegateBinding::StaticClass, TEXT("UInputDebugKeyDelegateBinding"), &Z_Registration_Info_UClass_UInputDebugKeyDelegateBinding, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInputDebugKeyDelegateBinding), 2332808390U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MyProject4_Plugins_EnhancedInput_Source_EnhancedInput_Public_InputDebugKeyDelegateBinding_h_1419733474(TEXT("/Script/EnhancedInput"),
		Z_CompiledInDeferFile_FID_MyProject4_Plugins_EnhancedInput_Source_EnhancedInput_Public_InputDebugKeyDelegateBinding_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MyProject4_Plugins_EnhancedInput_Source_EnhancedInput_Public_InputDebugKeyDelegateBinding_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_MyProject4_Plugins_EnhancedInput_Source_EnhancedInput_Public_InputDebugKeyDelegateBinding_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MyProject4_Plugins_EnhancedInput_Source_EnhancedInput_Public_InputDebugKeyDelegateBinding_h_Statics::ScriptStructInfo),
		nullptr, 0);
