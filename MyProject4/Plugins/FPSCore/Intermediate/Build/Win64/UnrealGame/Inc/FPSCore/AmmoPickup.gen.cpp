...
template<> FPSCORE_API UScriptStruct* StaticStruct<FAmmoTypeData>()
{
	...
	struct Z_CompiledInDeferFile_FID_MyProject4_Plugins_FPSCore_Source_FPSCore_Public_AmmoPickup_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MyProject4_Plugins_FPSCore_Source_FPSCore_Public_AmmoPickup_h_Statics::EnumInfo[] = {
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MyProject4_Plugins_FPSCore_Source_FPSCore_Public_AmmoPickup_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MyProject4_Plugins_FPSCore_Source_FPSCore_Public_AmmoPickup_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AAmmoPickup, AAmmoPickup::StaticClass, TEXT("AAmmoPickup"), &Z_Registration_Info_UClass_AAmmoPickup, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AAmmoPickup), 3709471411U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MyProject4_Plugins_FPSCore_Source_FPSCore_Public_AmmoPickup_h_1287409409(TEXT("/Script/FPSCore"),
		Z_CompiledInDeferFile_FID_MyProject4_Plugins_FPSCore_Source_FPSCore_Public_AmmoPickup_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MyProject4_Plugins_FPSCore_Source_FPSCore_Public_AmmoPickup_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_MyProject4_Plugins_FPSCore_Source_FPSCore_Public_AmmoPickup_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MyProject4_Plugins_FPSCore_Source_FPSCore_Public_AmmoPickup_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_MyProject4_Plugins_FPSCore_Source_FPSCore_Public_AmmoPickup_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MyProject4_Plugins_FPSCore_Source_FPSCore_Public_AmmoPickup_h_Statics::EnumInfo));
