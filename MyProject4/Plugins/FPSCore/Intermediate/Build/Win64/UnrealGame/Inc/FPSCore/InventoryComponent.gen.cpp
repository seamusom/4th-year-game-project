...
template<> FPSCORE_API UScriptStruct* StaticStruct<FStarterWeaponData>()
{
	...
	struct Z_CompiledInDeferFile_FID_MyProject4_Plugins_FPSCore_Source_FPSCore_Public_Components_InventoryComponent_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MyProject4_Plugins_FPSCore_Source_FPSCore_Public_Components_InventoryComponent_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MyProject4_Plugins_FPSCore_Source_FPSCore_Public_Components_InventoryComponent_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MyProject4_Plugins_FPSCore_Source_FPSCore_Public_Components_InventoryComponent_h_295411758(TEXT("/Script/FPSCore"),
		Z_CompiledInDeferFile_FID_MyProject4_Plugins_FPSCore_Source_FPSCore_Public_Components_InventoryComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MyProject4_Plugins_FPSCore_Source_FPSCore_Public_Components_InventoryComponent_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_MyProject4_Plugins_FPSCore_Source_FPSCore_Public_Components_InventoryComponent_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MyProject4_Plugins_FPSCore_Source_FPSCore_Public_Components_InventoryComponent_h_Statics::ScriptStructInfo),
		nullptr, 0);
